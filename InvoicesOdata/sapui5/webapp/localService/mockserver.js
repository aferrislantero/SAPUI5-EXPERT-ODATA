sap.ui.define([
     ...
     * @param { typeof sap/ui/model/js/JSONModel }JSONModel
    ...
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        var oMockServer,
            ...
            s_JsonFilesPath = _sAppPath + "localService/mockdata";

        var oMocServerInterface = {
            ...
            init: function (oOptionsParameter) {
                ...
                return new Promise(function (fnResolve, fnReject) {
                    var sManifest = sap.ui.require.toUrl(_sAppPath + "manifest.js"),
                        oManifestModel = new JSONModel(sManifest);

                    oManifestModel.attachRequestCompleted(function () {
                        var oUriParameters = new UriParameters(window.location.href);

                        //parse manifest for local metadata URI
                        var sJasonFileUrl = sap.ui.require.toUrl(s_JsonFilesPath);
                        ...
                        MockServer.config( {
                            autoRespond: true,
                            autoRespondAfter: (oOptions.dealy || oUriParameters.get("serverDelay") || 500 ),
                        } );

                        //simulate all request using mock data
                        oMockServer.simulate(sMetadataUrl,{
                            sMockdataBaseUrl : sJasonFileUrl,
                            bGenerateMissingMockData : true,
                        } );

                        var aRequests = pMockServer.getRequests();
